...
namespace AirlineManagement
{
    ...
    {
        SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Ali Bhatti\Source\Repos\Airline-Management-System-New\AirlineManagement\AirlineManagement\AirlineManagement\AirlineDatabase.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        {
            // Back should go to Home; if staff, Home will show admin options
            var home = new Home();
            home.Show();
            this.Hide();
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    var nationality = cmbNationality.SelectedItem != null ? cmbNationality.SelectedItem.ToString() : cmbNationality.Text;
                    var gender = cmbGender.SelectedItem != null ? cmbGender.SelectedItem.ToString() : cmbGender.Text;
                    cmd.Parameters.AddWithValue("@PassengerNationality", nationality);
                    cmd.Parameters.AddWithValue("@PassengerGender", gender);
